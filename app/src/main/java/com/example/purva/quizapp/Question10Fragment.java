...
public class Question10Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.question10_fragment,container,false);
        ques10 = v.findViewById(R.id.textViewQues10);
        next = v.findViewById(R.id.ButtonNext10);
        quesData = ques10.getText().toString();
        n = R.id.ButtonNext10;
        radioGroup = v.findViewById(R.id.radioGroup10);
        rdAns1 = v.findViewById(R.id.radioAnswer1Q10);
        rdAns2 = v.findViewById(R.id.radioAnswer2Q10);
        rdAns3 = v.findViewById(R.id.radioAnswer3Q10);
        rdAns4 = v.findViewById(R.id.radioAnswer4Q10);
