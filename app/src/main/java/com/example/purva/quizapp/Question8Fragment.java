...
public class Question8Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.question8_fragment,container,false);
        ques8 = v.findViewById(R.id.textViewQues8);
        next = v.findViewById(R.id.ButtonNext8);
        quesData = ques8.getText().toString();
        n = R.id.ButtonNext8;
        radioGroup = v.findViewById(R.id.radioGroup8);
        rdAns1 = v.findViewById(R.id.radioAnswer1Q8);
        rdAns2 = v.findViewById(R.id.radioAnswer2Q8);
        rdAns3 = v.findViewById(R.id.radioAnswer3Q8);
        rdAns4 = v.findViewById(R.id.radioAnswer4Q8);
