...
public class Question3Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.question3_fragment,container,false);
        ques3 = v.findViewById(R.id.textViewQues3);
        next = v.findViewById(R.id.ButtonNext3);
        quesData = ques3.getText().toString();
        n = R.id.ButtonNext3;
        radioGroup = v.findViewById(R.id.radioGroup3);
        rdAns1 = v.findViewById(R.id.radioAnswer1Q3);
        rdAns2 = v.findViewById(R.id.radioAnswer2Q3);
        rdAns3 = v.findViewById(R.id.radioAnswer3Q3);
        rdAns4 = v.findViewById(R.id.radioAnswer4Q3);
