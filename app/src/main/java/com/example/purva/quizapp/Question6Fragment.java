...
public class Question6Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.question6_fragment,container,false);
        ques6 = v.findViewById(R.id.textViewQues6);
        next = v.findViewById(R.id.ButtonNext6);
        quesData = ques6.getText().toString();
        n = R.id.ButtonNext6;
        radioGroup = v.findViewById(R.id.radioGroup6);
        rdAns1 = v.findViewById(R.id.radioAnswer1Q6);
        rdAns2 = v.findViewById(R.id.radioAnswer2Q6);
        rdAns3 = v.findViewById(R.id.radioAnswer3Q6);
        rdAns4 = v.findViewById(R.id.radioAnswer4Q6);
